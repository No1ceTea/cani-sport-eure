            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="primary_text mt-4 flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-4 pb-4 w-full">
                <a href="https://instagram.com/canisports_eure" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2">
                  <img src="/logos/instagram.svg" alt="Instagram" className="h-5" />
                ...
                <a href="https://facebook.com/canisports.eure" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2">
                  <img src="/logos/facebook.svg" alt="Facebook" className="h-5" />
              ...
              {/* Copyright */}
              <p className="text-sm text-center md:text-left">© Cani Sports - Eure, Tous droits réservés</p>
            </div>
