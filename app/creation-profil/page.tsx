...
export default function UserProfileForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let imageUrl = form.photo_profil; // Conserver l'ancienne URL si aucune nouvelle image n'est sélectionnée
    ...
    // 🔥 Enregistrement des données de l'utilisateur dans Supabase
    const { data, error } = await supabase.from("profils").upsert([
      {
        ...form,
        photo_profil: imageUrl, // Stocker l'URL de l'image dans la base de données
      },
    ]);
